...
class _KidsDashboardState extends State<KidsDashboard> {
  ...
  Stream<List<Map<String, dynamic>>> getChoresStream() {
    return FirebaseFirestore.instance
        ...
        .where(
          'kid_id',
          isEqualTo: widget.kidId,
        ) // Changed from 'kidId' to 'kid_id'
        .snapshots()
        .map(
            ...
            child: Container(
              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  final liveBalance = (liveDoc['total_amount_left'] ?? 0)
                      .toDouble();
                          ...
                          children: [
                            ...
                            StreamBuilder<QuerySnapshot>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final balance = (data['total_amount_left'] ?? 0)
                                    .toDouble();
                          ...
                          StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              if (snapshot.hasData &&
                                ...
                                liveBalance = (data['total_amount_left'] ?? 0)
                                    .toDouble();
                              }
                          ...
                          builder: (context, snapshot) {
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return GestureDetector(
                                  onTap: () =>
                                      _showMarkAsCompletePrompt(context, chore),
                                  child: SizedBox(
                                    height: 90,
                                    child: Card(
  ...
  void _showMarkAsCompletePrompt(
